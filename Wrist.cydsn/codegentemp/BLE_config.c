...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x09u, 0x09u, 0x57u, 0x72u,
        0x69u, 0x73u, 0x74u, 0x42u, 0x4Cu, 0x45u, 0x02u,
        0x0Au, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
...
static cy_stc_ble_gapc_scan_params_t cy_ble_gapcScanConfig[0x01u] = {
    ...
    {
        .fastScanInterval                   = 0x0038u, 
        .fastScanWindow                     = 0x0030u, 
        .fastScanTimeOut                    = 0x0005u, 
...
static uint8_t cy_ble_attValues[0x18u] = {
    /* Device Name */
    (uint8_t)'W', (uint8_t)'r', (uint8_t)'i', (uint8_t)'s', (uint8_t)'t', (uint8_t)'B', (uint8_t)'L', (uint8_t)'E', 
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x0Fu] = {
